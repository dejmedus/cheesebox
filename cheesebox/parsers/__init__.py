...
from cheesebox.parsers.conversion import conversion_parser

all_parsers = [math_parser, conversion_parser, measurement_parser, catch_all_parser, greetings_parser]
